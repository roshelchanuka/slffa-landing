    ...
    <div className="flex flex-col min-h-screen bg-slate-50 dark:bg-slate-950 transition-colors duration-300">
      ...
      <section className="relative h-[55vh] min-h-[380px] sm:h-[65vh] sm:min-h-[450px] lg:h-screen flex items-center bg-slffaBlue overflow-hidden">
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full mt-24">
          ...
          <Editable id="about.hero.subtitle" type="textarea" defaultContent="SLFFA Cargo Services Ltd â€” Facilitating the smooth, secure, and highly efficient flow of air imports in Sri Lanka since 1994.">
            <motion.p
              initial={{ opacity: 1, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              SLFFA Cargo Services Ltd â€” Facilitating the smooth, secure, and highly efficient flow of air imports in Sri Lanka since 1994.
            </motion.p>
          </Editable>
        </div>
