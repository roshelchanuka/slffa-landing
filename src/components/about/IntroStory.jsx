        ...
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          ...
          <div className="w-full lg:w-7/12">
            ...
            >
              ...
              <Editable id="about.corporate.desc_2" type="textarea" defaultContent="The Company, which was formed under the Company Act No. 17 of 1982, has served the industry for over 30 years. Its principal activity continues to be facilitating the smooth Ground of import cargo brought by air into the country. The delivery of cargo averages 25 metric tons per day. We service large scale garments manufacturers and other leading importers to handle their cargo through our 25,000 square foot terminal based on the quality of personalized service we provide. Our customer base consists of over 75 leading forwarding agents in the country and over 300 consignees representing many trade sectors.">
                <motion.p variants={itemVariants} className="text-slate-600 dark:text-slate-400 leading-relaxed">
                  The Company, which was formed under the Company Act No. 17 of 1982, has served the industry for over 30 years. Its principal activity continues to be facilitating the smooth Ground of import cargo brought by air into the country. The delivery of cargo averages 25 metric tons per day. We service large scale garments manufacturers and other leading importers to handle their cargo through our 25,000 square foot terminal based on the quality of personalized service we provide. Our customer base consists of over 75 leading forwarding agents in the country and over 300 consignees representing many trade sectors.
                </motion.p>
              </Editable>
