    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 mb-24">
      ...
      >
        ...
        <div className="prose prose-lg prose-slate text-slate-600 dark:text-slate-400 leading-relaxed max-w-none text-left md:text-justify mx-auto space-y-6">
          ...
          <Editable id="ccnhub.overview.description" type="textarea" defaultContent="CCN Hub is a carrier-neutral, secure web portal where agents can check flight schedule availability, place a booking, submit MAWBs, Print HAWBs, track status of shipments and many other functions related to Agents and Airlines. Cargo agents are able to send messages ranging from (FFR â€“ e-booking requests, FWB â€“ AWB Data, FHL â€“ HAWB data, FSR â€“ shipment status requests, FVR/FIR â€“ availability/schedule requests) to airlines and receive messages on (FFA â€“ e-booking agreement, FSA â€“ shipment status answers, FSU â€“ shipment status update, FMA â€“ positive acknowledgement, FNA â€“ error message, FVA/FIA â€“ availability/ schedule answers) from airlines via CCNhub/FTP gateway.">
            <p>
              <strong>CCN Hub</strong> is a carrier-neutral, secure web portal where agents can check flight schedule availability, place a booking, submit MAWBs, Print HAWBs, track status of shipments and many other functions related to Agents and Airlines. Cargo agents are able to send messages ranging from (<strong>FFR</strong> â€“ e-booking requests, <strong>FWB</strong> â€“ AWB Data, <strong>FHL</strong> â€“ HAWB data, <strong>FSR</strong> â€“ shipment status requests, <strong>FVR/FIR</strong> â€“ availability/schedule requests) to airlines and receive messages on (<strong>FFA</strong> â€“ e-booking agreement, <strong>FSA</strong> â€“ shipment status answers, <strong>FSU</strong> â€“ shipment status update, <strong>FMA</strong> â€“ positive acknowledgement, <strong>FMA</strong> â€“ error message, <strong>FVA/FIA</strong> â€“ availability/ schedule answers) from airlines via CCNhub/FTP gateway.
            </p>
          </Editable>
          <div className="bg-sky-50 border-l-4 border-slffaBlue p-6 rounded-r-2xl my-8 text-left">
            <Editable id="ccnhub.overview.inhouse" type="textarea" defaultContent="In addition, CCN has the option to connect your in-house system which will provide you the convenience of submitting the AWB and FHL directly via the in-house system. CCNhub is a one-stop-shop for the agents which will benefit from our partner airlines on a carrier neutral, secure web portal â€“ CCNhub which would streamline your cargo handling process. Furthermore, you will be entitled to the ongoing waivers granted by the respective airlines for your e-submissions.">
